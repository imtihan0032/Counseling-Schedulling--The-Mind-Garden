        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Cheack and Manage Your Upcoming Appointments</p>
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Are you sure you want to cancel this appontment?</h2>
                        <a class="close" href="appointment.php">&times;</a>
                        <div class="content">
                        Once confirmed this action cannot be undone<br><br>
