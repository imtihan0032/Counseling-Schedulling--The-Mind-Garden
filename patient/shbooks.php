    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr >
                ...
                <td>
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600; color: #0A76D8">Books</p>
                    <p style="font-size: 15px;padding-left:12px;font-weight: 600; color: #1969AA">We have a curated selection of books covering a wide range of topics related to mental health.</p>
