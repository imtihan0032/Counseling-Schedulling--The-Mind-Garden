                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Type doctor's name or your preferred date for appointment" list="doctors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
            ...
            ?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;width: 100%;" >
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $searchtype." Available Sessions "."(".$result->num_rows.")"; ?> </p>
