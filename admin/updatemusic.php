...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE music SET name='$product_name', price='$product_price', image='$product_image', link = '$product_link'  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($database, "SELECT * FROM music WHERE id = '$id'");
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="addmusic.php" class="btn1">Cancel</a>
   </form>
