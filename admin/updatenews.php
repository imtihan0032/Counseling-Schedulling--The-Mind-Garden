...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $update_data = "UPDATE news SET name='$product_name', price='$product_price', image='$product_image', link = '$product_link'  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" name="product_name" value="<?php echo $row['name']; ?>" placeholder="Update news or event title">
      <input type="text" min="0" class="box" name="product_price" value="<?php echo $row['price']; ?>" placeholder="Update deatils about the event">
